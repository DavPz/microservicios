...
public class AccountAggregate {
    ...
    public AccountAggregate(CreateAccountCommand createAccountCommand){
        ...
        if (createAccountCommand.getInitialBalance() < 0){
            throw new NegativeInitialBalanceException("Error, no se puede tener Saldo Negativo");
        }
    ...
    public void handle(DebitAccountCommand debitAccountCommand){
        ...
        if (debitAccountCommand.getAmount() < 0){
            throw new NegativeInitialBalanceException("No s epuede retirar montos negativos");
        }
